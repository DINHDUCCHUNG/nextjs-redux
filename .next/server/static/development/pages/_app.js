...
var _jsxFileName = "/home/pilot/JS/with-redux-thunk-app/lib/with-redux-store.js";
    ...
    return next => {
      return action => {
        if (typeof action.payload === 'object' && action.payload.query) {
          ...
          isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_1___default()(`${url}/graphql`, {
            method: 'POST',
            headers,
...
var _jsxFileName = "/home/pilot/JS/with-redux-thunk-app/pages/_app.js";
...
const appStore = Object(redux__WEBPACK_IMPORTED_MODULE_0__["combineReducers"])({
...
function initializeStore() {
  return Object(redux__WEBPACK_IMPORTED_MODULE_0__["createStore"])(_reducers_index__WEBPACK_IMPORTED_MODULE_3__["default"], Object(redux_devtools_extension__WEBPACK_IMPORTED_MODULE_1__["composeWithDevTools"])(Object(redux__WEBPACK_IMPORTED_MODULE_0__["applyMiddleware"])(Object(_middlewares_graphql_middleware__WEBPACK_IMPORTED_MODULE_5__["default"])(_config__WEBPACK_IMPORTED_MODULE_4__["default"].BASE_URL), redux_thunk__WEBPACK_IMPORTED_MODULE_2___default.a)));
}
