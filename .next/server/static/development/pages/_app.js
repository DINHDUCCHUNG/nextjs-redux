    ...
    return next => {
      return async action => {
        if (typeof action.payload === 'object' && action.payload.query) {
          ...
          await isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_1___default()(`${url}/graphql`, {
            method: 'POST',
            headers,
...
/* harmony default export */ __webpack_exports__["default"] = (next_redux_wrapper__WEBPACK_IMPORTED_MODULE_3___default()(_store__WEBPACK_IMPORTED_MODULE_4__["initializeStore"])(class MyApp extends next_app__WEBPACK_IMPORTED_MODULE_2___default.a {
  ...
  render() {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(next_app__WEBPACK_IMPORTED_MODULE_2__["Container"], null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_redux__WEBPACK_IMPORTED_MODULE_1__["Provider"], {
      store: store
...
const initState = {};
function initializeStore(initialState = initState) {
